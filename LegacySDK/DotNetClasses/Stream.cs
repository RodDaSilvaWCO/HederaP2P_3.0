...
//#define NULL_STREAM				// StreamReader needs *this* NullStream implementation
...
//{
//	/// <summary>
//	/// This class currently only provides additional methods to avoid needing the System.IO.SeekOrigin class,
//	/// but is where any additional future Unosys functionality can be added at the stream level
//	/// </summary>
//	[Serializable]
//	[ComVisible( true )]
...
//#if NULL_STREAM
//		public static new readonly Stream Null = new NullStream();
//#endif
...
//		/// <summary>
//		/// Sets the position within the current stream relative to the beginning of the stream
//		/// </summary>
//		/// <param name="offset">A byte offset</param>
//		/// <returns>The new position within the current stream</returns>
//		public virtual long SeekFromBegin( long offset )
//		{
//			return this.Seek( offset, System.IO.SeekOrigin.Begin );
//		}

//		/// <summary>
//		/// Sets the position within the current stream relative to the current position within the stream
//		/// </summary>
//		/// <param name="offset">A byte offset</param>
//		/// <returns>The new position within the current stream</returns>
//		public virtual long SeekFromCurrent( long offset )
//		{
//			return this.Seek( offset, System.IO.SeekOrigin.Current );
//		}

//		/// <summary>
//		/// Sets the position within the current stream relative to the end of the stream
//		/// </summary>
//		/// <param name="offset">A byte offset</param>
//		/// <returns>The new position within the current stream</returns>
//		public virtual long SeekFromEnd( long offset )
//		{
//			return this.Seek( offset, System.IO.SeekOrigin.End );
//		}
//#if NEW_EXPERIMENTAL_ASYNC_IO
...
//#endif
//#if OVERRIDE_ABSTRACT
//		public abstract override bool CanRead
//		{
//			[Pure]
//			get;
//		}
...
//		public abstract override bool CanSeek
//		{
//			[Pure]
//			get;
//		}

//		public abstract override bool CanWrite
//		{
//			[Pure]
//			get;
//		}
...
//		public abstract override long Position
//		{
//			get;
//			set;
//		}
...
//		public abstract override int Read( [In, Out] byte[] buffer, int offset, int count );
...
//		////[HostProtection( ExternalThreading = true )]
//		protected IAsyncResult BeginWriteInternal( byte[] buffer, int offset, int count, AsyncCallback callback, Object state, bool serializeAsynchronously )
//		{
//			Contract.Ensures( Contract.Result<IAsyncResult>() != null );
...
//				//	Task.CompletedTask;		// Exists in .net v4.6
//            }
//#endif // FEATURE_ASYNC_IO
...
//            {
//				if (s_nullReadTask == null)
//					s_nullReadTask = new Task<int>( null, CancellationToken.None, TaskCreationOptions.None );
//				//s_nullReadTask = new Task<int>( false, 0, (TaskCreationOptions) InternalTaskOptions.DoNotDispose, CancellationToken.None ); // benign ----
...
//		{
//			throw new NotImplementedException( "Not implemented, use ManualResetEvent(false) instead" );
...
//		{
//			throw new NotImplementedException( "Do not call or override this method" );
//		}
//#endif
...
//			//return cancellationToken.IsCancellationRequested
//			//			? Task.FromCancellation<int>(cancellationToken)	// <- Method is internal until 4.5.3 is released
//			//			: BeginEndReadAsync(buffer, offset, count);
//			cancellationToken.ThrowIfCancellationRequested();
//			return BeginEndReadAsync( buffer, offset, count );
//		}

//		private Task<int> BeginEndReadAsync( Byte[] buffer, Int32 offset, Int32 count )
//		{
//			throw new NotImplementedException( "ReadAsync not implemented for Stream" );
...
//			// Can't seem to get this to go without the internal FromAsyncTrim method:
//			//object state = new ReadWriteParameters { Buffer = buffer, Offset = offset, Count = count };
//			//return Task.Factory.FromAsync<int>( BeginRead, EndRead, state, TaskCreationOptions.None );
//		}
...
//			// Otherwise, return a task that represents the Begin/End methods.
//			//return cancellationToken.IsCancellationRequested
//			//			? Task.FromCancellation(cancellationToken)	// <- Method is internal until 4.5.3 is released
...
//		{
//			throw new NotImplementedException( "WriteAsync not implemented for Stream" );
//			// Can't seem to get this to go without the internal FromAsyncTrim method:
