...
namespace Unosys.SDK
{
	...
	public class StreamWriter : System.IO.TextWriter
	{
		...
		public new static readonly StreamWriter Null = new StreamWriter( System.IO.Stream.Null, new UTF8Encoding( false, true ), MinBufferSize, true );
		...
		private void CheckAsyncTaskInProgress()
		{
			...
			if (t != null && !t.IsCompleted)
				throw new InvalidOperationException( "InvalidOperation_AsyncIOInProgress" );
		}
#endif
		...
		public StreamWriter( System.IO.Stream stream, Encoding encoding, int bufferSize, bool leaveOpen )
			: base( null ) // Ask for CurrentCulture all the time
		{
			...
			if (bufferSize <= 0) throw new ArgumentOutOfRangeException( "bufferSize", "ArgumentOutOfRange_NeedPosNum" );
		...
		{ // Ask for CurrentCulture all the time
			...
			System.IO.Stream stream = CreateFile( path, append, checkHost );
			Init( stream, encoding, bufferSize, false );
		}

		[System.Security.SecuritySafeCritical]
		private void Init( System.IO.Stream streamArg, Encoding encodingArg, int bufferSize, bool shouldLeaveOpen )
		{
		...
		[ResourceExposure( ResourceScope.Machine )]
		[ResourceConsumption( ResourceScope.Machine )]
		private static System.IO.Stream CreateFile( string path, bool append, bool checkHost )
		{
		...
		private void Flush( bool flushStream, bool flushEncoder )
		{
			...
			// and UTF-8 encoders.  
			if (stream == null)
				throw new InvalidOperationException( "WriterCLosed - stream is null" );
		...
		private static async Task FlushAsyncInternal( StreamWriter _this, bool flushStream, bool flushEncoder,
													 ...
													 Encoding encoding, Encoder encoder, Byte[] byteBuffer, System.IO.Stream stream )
		{
			if (!haveWrittenPreamble)
			{
        ...
        private sealed class MdaHelper
        {
            ...
            ~MdaHelper()
            {
                ...
                if (streamWriter.charPos != 0 && streamWriter.stream != null && streamWriter.stream != System.IO.Stream.Null) {
