...
{
	/// <summary>
	/// A collection of common constants and structs from the Win32 domain
	/// </summary>
    ...
    internal static class Win32Native {
        ...
        /* Remove this structure in favour of the FileAttributes return object and an internal DTO
		[Serializable]
        [StructLayout(LayoutKind.Sequential)]
 ...
 */
        ...
        internal static String GetMessage(int errorCode) {
			...
			// Whatever.  Replace all that with this:
			return string.Format( "UnknownError_Num {0}", errorCode );
		}
/*        
#if FEATURE_PAL
 ...
 */
        ...
        internal static int MakeHRFromErrorCode(int errorCode)
        {
            ...
            {
                Debug.Print("This is an HRESULT, not an error code!");
            }
 ...
 /*
        ...
        {
            return MoveFileEx(src, dst, 2);// 2 == MOVEFILE_COPY_ALLOWED
        }
#else // FEATURE_CORESYSTEM
        [DllImport(KERNEL32, SetLastError=true, CharSet=CharSet.Auto, BestFitMapping=false)]
        [ResourceExposure(ResourceScope.Machine)]
